...
var Uri = "";
const ApiLMuebles = ListarMuebles(Url + "Mueble/Muebles");
...
const ProductsPage = () => {
  ...
  //Realiza la consulta a la API (Devuelve la lista de Muebles)
  const data = ApiLMuebles.read();
              ...
              {data.response.map((mueble) => (
                <tr key={mueble.idMueble}>
                  ...
                  <td className="d-flex justify-content-center g-3">
                    ...
                    &nbsp;
                    <button onClick={() => BorrarMueble(mueble.idMueble, mueble.nombre)} className='btn btn-danger'>
